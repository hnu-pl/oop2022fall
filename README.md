...
두 책 모두 객체지향이나 함수형 프로그래밍 패러다임에 대해서 역사적 맥락이나 학문적 의미를 정확하게 전달하는 책은 아니다. 특히 함수형 프로그래밍에 대해서는 더더욱 그러하다. 자바나 코틀린을 사용하는 입장에서 함수형 프로그래밍을 어떻게 바로 코드에 적용해 볼 수 있는지만을 이야기하고 있다는 점에 유의할 필요가 있다.
